    ...
    return (
        <>
            ...
            <div className="flex flex-col w-full lg:w-2/3">
                <div className="px-6 py-5 bg-white border border-b-gray-600">
                ...
                <div
                    className="flex-1 h-screen px-2 pb-5 overflow-y-scroll lg:px-8 bg-blue-200 rounded-md overflow hover:overflow_type"
                    ref={scrollRef}
                >
                        ...
                        <div className="flex items-center py-2 border-t border-gray-700 px-9">
                            <div className="flex items-center justify-between w-full px-2 py-1.5 bg-gray-700/50 border-gray-600 border-l-4 rounded">
                                <div className="text-[10px] lg:text-xs">
                                    ...
                                    <div
                                        className="overflow-hidden text-gray-200/80"
                                        style={{
                                            display: "-webkit-box",
                                            WebkitLineClamp: 2,

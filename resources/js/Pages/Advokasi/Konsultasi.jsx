...
export default function Konsultasi({ title, auth, laporan_konsultasi }) {
    console.log(laporan_konsultasi);
                            ...
                            {currentItems.map((item, index) => (
                                ...
                                >
                                    <th className="font-normal text-sm ">
                                        {item?.approval_tracker.konsultasi.id}
                                    </th>
                                    <td>

                ...
                <div className="relative flex flex-row-reverse group">
                    ...
                    {/* {!message.message_deleted_at && (
                        <div className="relative">
                            <div className="absolute top-0 bottom-0 left-0 flex flex-row items-center justify-center text-xs font-extrabold text-gray-700 opacity-0 -ml-14 group-hover:opacity-100">
                    ...
                    {isFirstMessage && (
                        <div className="absolute top-0 w-4 h-4 bg-indigo-400 rounded-br-full -right-2"></div>
                    )}
                </div>
            </div>
        </>

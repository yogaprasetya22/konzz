                ...
                <div className="relative flex flex-row group">
                    <div
                        className={clsx(
                            ...
                            "py-2 pl-3 pr-3 text-xs font-extrabold text-gray-800 bg-gray-100 rounded-md lg:text-sm"
                        )}
                    >
                        {/* Replied Chat */}
                            ...
                            <div className="max-w-full px-2 py-1.5 mb-1.5 bg-gray-700/50 border-gray-600 border-l-4 rounded">
                                <div className="text-[10px] lg:text-xs font-extrabold">
                                    ...
                                    {!message.reply.message_deleted_at ? (
                                        <div
                                            className="overflow-hidden text-gray-800/80"
                                            style={{
                                                display: "-webkit-box",
                                                WebkitLineClamp: 2,
                                        ...
                                        <div className="flex items-center mr-1 text-xs font-extrabold italic text-center select-none text-gray-400/60">
                                            {message.reply.message}
                                        </div>
                                    )}
                                </div>
                        ...
                        {!message.message_deleted_at ? (
                            ...
                            <div className="flex items-center justify-center mr-1 text-xs font-extrabold italic text-center select-none text-gray-400/60">
                                {message.message}
                            </div>
                        )}
                    ...
                    {/* {!message.message_deleted_at && (
                        <div className="relative">
                            <div className="absolute top-0 bottom-0 right-0 flex flex-row items-center justify-center -mr-8 text-xs font-extrabold text-gray-700 opacity-0 group-hover:opacity-100">
                    ...
                    {isFirstMessage && (
                        <div className="absolute top-0 w-4 h-4 bg-gray-100 rounded-bl-full -left-2"></div>
                    )}
                </div>
            </div>
        </>

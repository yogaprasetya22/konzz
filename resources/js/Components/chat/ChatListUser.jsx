...
import ProfilePictureOnChat from "./ProfilePictureOnChat";
...
export default function ChatListUser() {
    ...
    return (
        <>
            <div
                className="flex-1 mt-3 space-y-3 overflow-y-auto"
                scroll-region="true"
            >
                {users.map((user) => {
                    let chat = null;
                        ...
                        <Link
                            ...
                            className={clsx(
                                user.id === chatWithUser?.id
                                    ? "bg-indigo-400"
                                    : "bg-indigo-400/20",
                                "flex w-full items-center hover:bg-indigo-400/60 px-2.5 py-3 rounded-md"
                            )}
                        >
                            ...
                            <div className="flex flex-col flex-1 min-w-0 pr-2">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center text-xs text-gray-700">
                                        ...
                                        {chat?.message_deleted_at ? (
                                            <span className="mr-2 italic text-gray-500">
                                                {chat?.message}
                                            </span>
                                        ) : (
                                            <div

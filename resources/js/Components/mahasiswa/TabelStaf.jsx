...
import ModalAddStaf from "../ui/ModalAddStaf";
import ModalEditStaf from "../ui/ModalEditStaf";

export default function TabelStaf({ dataUser }) {
    ...
    const handleDelete = (id) => async (e) => {
        e.preventDefault();
        const response = await axios.delete(`/delete-staf/${id}`);
                            ...
                            <tbody>
                                ...
                                {currentItems.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <td>
                                            <p className="font-light text-blue-500 cursor-pointer text-xs hover:underline">
                                                {item?.unit?.kontak}
                                            </p>
                                        </td>
                                        <td>
